...
class TestExpPerformance(GF2nTest):

    @SetIterateValue(framework=["Cuda", "OpenSSL"])
    @SetIterateValue(bits=[128, 512, 1024, 2048, 8191, 16381, 32767])
    @SetIterateValue(k=[10, 100, 1000])
    @SetIterateValue(function=["parExponentiation"])
    @UnitTest()
